...
namespace ProjectMT.Shared.Combat
{
    ...
    public struct MonsterActiveFocusPreset // 등급별 집중 강도
    {
        ...
        [SerializeField, Range(0.05f, 0.3f)] private float fadeOut;
            ...
            Color accentColor)
        {
            ...
            this.fadeOut = Mathf.Clamp(fadeOut, 0.05f, 0.3f);
        ...
        public float MinimumVisibleDuration => minimumVisibleDuration <= 0f ? 1.5f : minimumVisibleDuration;
