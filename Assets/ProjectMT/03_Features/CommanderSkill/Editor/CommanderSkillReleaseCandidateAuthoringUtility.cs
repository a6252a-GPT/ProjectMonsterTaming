...
namespace ProjectMT.Features.CommanderSkill.Editor
{
    public static class CommanderSkillReleaseCandidateAuthoringUtility
    {
        ...
        public static void Build()
        {
            ...
            {
                CreateSkill(new SkillSpec("CS_TrackingBlade", "추적의 검인", CommanderSkillRarity.Common, 8f, 18f,
                ...
                CreateSkill(new SkillSpec("CS_DoomSpear", "파멸의 창", CommanderSkillRarity.Common, 10f, 20f,
                    CommanderSkillTargetSelection.Nearest, MonsterBasicAttackDeliveryModule.Projectile,
                ...
                CreateSkill(new SkillSpec("CS_AbyssChain", "구속의 사슬", CommanderSkillRarity.Common, 9f, 20f,
                ...
                CreateSkill(new SkillSpec("CS_PhantomCharge", "군세의 돌진", CommanderSkillRarity.Rare, 12f, 15f,
                ...
                CreateSkill(new SkillSpec("CS_ConquerorSigil", "정복자의 문장", CommanderSkillRarity.Rare, 14f, 20f,
                ...
                CreateSkill(new SkillSpec("CS_PhantomBarrage", "유령 포격", CommanderSkillRarity.Rare, 13f, 20f,
                    CommanderSkillTargetSelection.MostCrowded, MonsterBasicAttackDeliveryModule.TravelingArea,
                ...
                CreateSkill(new SkillSpec("CS_DeathSentence", "사형 선고", CommanderSkillRarity.Epic, 16f, 20f,
                ...
                CreateSkill(new SkillSpec("CS_RuptureMarch", "파열의 행진", CommanderSkillRarity.Epic, 15f, 20f,
                    CommanderSkillTargetSelection.MostCrowded, MonsterBasicAttackDeliveryModule.TravelingArea,
                ...
                CreateSkill(new SkillSpec("CS_HeartOfBattlefield", "전장의 심장", CommanderSkillRarity.Legendary, 18f, 20f,
                    CommanderSkillTargetSelection.MostCrowded, MonsterBasicAttackDeliveryModule.TravelingArea,
                ...
                CreateSkill(new SkillSpec("CS_MarchOfDead", "망자의 대행진", CommanderSkillRarity.Legendary, 20f, 18f,
                    CommanderSkillTargetSelection.MostCrowded, MonsterBasicAttackDeliveryModule.Direct,
                ...
                CreateSkill(new SkillSpec("CS_WarGodBrand", "군신의 낙인", CommanderSkillRarity.Mythic, 22f, 20f,
                    CommanderSkillTargetSelection.Strongest, MonsterBasicAttackDeliveryModule.Direct,
                    CommanderSkillTrajectory.Straight, 0f, CommanderSkillPatternType.Single, 1, 0f,
            ...
            SfxCue impactSfx, GameObject castVfx, GameObject impactVfx)
        {
            ...
            return CreateSkill(new SkillSpec("CS_ApocalypseWar", "종말 전쟁", CommanderSkillRarity.Mythic, 28f, 20f,
                CommanderSkillTargetSelection.MostCrowded, MonsterBasicAttackDeliveryModule.TravelingArea,
                CommanderSkillTrajectory.Straight, 0f, CommanderSkillPatternType.PersistentArea, 1, 0f,
            ...
            params CommanderSkillEffectDefinition[] extraEffects)
        {
            ...
            skill.EditorConfigure(spec.Id, spec.Name, CommanderSkillApprovedConcept.DescriptionFor(spec.Id),
                ...
                skill.ProjectilePrefab != null ? skill.ProjectilePrefab : projectile,
                CommanderSkillApprovedConcept.ProjectileSpeedFor(spec.Id), spec.Trajectory, spec.ArcHeight,
