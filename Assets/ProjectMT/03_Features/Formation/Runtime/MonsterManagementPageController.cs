...
namespace ProjectMT.Features.Formation
{
    ...
    public sealed class MonsterManagementPageController : MonoBehaviour // 몬스터 조회·성장 관리창
    {
        ...
        private void UpdateTabState()
        {
            ...
            growthTabButton?.GetComponent<UIStateVisual>()?.SetSelected(!showingBreakthrough);
            breakthroughTabButton?.GetComponent<UIStateVisual>()?.SetSelected(showingBreakthrough);
