    ...
    public sealed class CombatTuningTableWindow : EditorWindow // 공용 전투 수치 표 편집기
    {
        ...
        private static string ResolveConfigValueTooltip(string propertyName)
        {
            return propertyName switch
            {
                ...
                "mainBattleEnemySpawnSpreadMultiplier" => "MainBattle 적이 입장할 때 진형 간격에 추가로 곱하는 값. 현재 약 2.26244면 기본 프로필을 포함해 적 한 마리와 옆 적 사이의 최종 간격이 2.5m가 됩니다. 전투 중 밀어내는 값이 아닙니다.",
